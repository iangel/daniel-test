...
(function ($) {
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            ...
            onItemClick: function (data, label) { 
				/*var openSubTab = function openSubTab(result) {
					alert(result.Id);
					sforce.console.openSubtab(result.Id, '/'+data, true,'Project Task',null);
				}
				sforce.console.getEnclosingPrimaryTabId(openSubTab);*/			
				var win = window.open("/"+data+"/e?saveURL=%2F"+data+"&retURL=%2F"+data, "_target", "toolbar=no, scrollbars=yes, resizable=no, left=100, top=100, width=800, height=500");			
        ...
        */
        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var entries = [];
				entries.push('<table style="font-family:Arial,Helvetica,sans-serif;">');
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage && i < (element.pageNum * settings.itemsPerPage + settings.itemsPerPage)) {
						if(entry.fullScreen=='true') {
							if(i==0) {
								entries.push('<table style="font-family:Arial,Helvetica,sans-serif;" width="1200px;">');
								fullScreen = true;								
							}
							entries.push('<tr class="row name row' + i +' fn-wide' + '" id="rowheader' + i + '" offset="' + i % settings.itemsPerPage * tools.getCellSize() + '"  style="width:1200px !important;">');
							entries.push('<td class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '" style="width:1200px !important;margin-bottom:5px !important;"><table><tr><td style="width:300px;">'+((entry.name=='' || entry.name ==null)?entry.desc : entry.name)+'</td></tr></table></td>')
							entries.push('</tr>');
						}
						else {
							...
							entries.push('<div class="fn-label' + (entry.cssClass ? ' ' + entry.cssClass : '') + '" style="word-wrap: break-word;">' +(entry.name==undefined?'':entry.name)+'</div>');
				...
				if(fullScreen) {
					entries.push('</table');
					ganttLeftPanel = $('<div class="leftPanel" style="width:200px !important;"/>')
						.append($('<div class="row spacer" style="width:1200px !important"><table style="margin-top:'+(tools.getCellSize() * element.headerRows - 20) +'px !important;height:25px !important"><tr><th style="width:100px;background-color: #1797C0 !important;">Milestone Name</th></tr></table></div>')
					...
					ganttLeftPanel = $('<div class="leftPanel" />')
						...
						.css("height", tools.getCellSize() * element.headerRows + "px")
						.css("width", "100%"));
					$('.fn-wide').css("width", "255px !important");
					$('.fn-label').css("width", "255px !important");
				}
...
if(rday.getMonth() == 0){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Jan' + '</div>');		
}

if(rday.getMonth() == 1){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Feb' + '</div>');		
}

if(rday.getMonth() == 2){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Mar' + '</div>');		
}

if(rday.getMonth() == 3){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Apr' + '</div>');		
}

if(rday.getMonth() == 4){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'May' + '</div>');		
}

if(rday.getMonth() == 5){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Jun' + '</div>');		
}	
                           
if(rday.getMonth() == 6){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Jul' + '</div>');		
}

if(rday.getMonth() == 7){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Aug' + '</div>');		
}

if(rday.getMonth() == 8){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Sep' + '</div>');		
}

if(rday.getMonth() == 9){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Oct' + '</div>');		
}

if(rday.getMonth() == 10){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Nov' + '</div>');		
}

if(rday.getMonth() == 11){
	 monthArr.push('<div class="row day wd" id="dh-' + tools.genId(rday.getTime()) + '" offset="' + i * tools.getCellSize() + '" repdate="' + rday.getRepDate() + '">' + 'Dec' + '</div>');		
}
            ...
            navigation: function (element) {
                ...
                if (settings.navigate === "scroll") {
					...
					*/			
								.append($('<button type="button" class="nav-selectedZoom"/>')
									.html('D')
									.click(function () {
										core.selectedZoom(element, 4, 'days');
                                    }))
								.append($('<button type="button" class="nav-selectedZoom"/>')
									.html('W')
									.click(function () {
										core.selectedZoom(element, 4, 'weeks');
                                    }))
								.append($('<button type="button" class="nav-selectedZoom"/>')
									.html('M')
									.click(function () {
										core.selectedZoom(element, 4, 'months');
                                    }))
                                    )
                                );
            ...
            // the entire chart
            createProgressBar: function (days, color, cls, desc, label, dataObj) {
		//alert("color1"+color);
		//alert("days"+days);
		...
		if(color == "Green"){
			var bar = $('<div class="barGreen"><div class="fn-label"></div></div>')
			.addClass(cls)
                        .css({
			...
			var bar = $('<div class="barRed"><div class="fn-label"></div></div>')
			.addClass(cls)
                        .css({
                            width: ((cellWidth * days) - barMarg) + 2
                        }) 			
			...
			var bar = $('<div class="barYellow"><div class="fn-label"></div></div>')
			.addClass(cls)
                        .css({
                            width: ((cellWidth * days) - barMarg) + 2
                        }) 			
			...
			var bar = $('<div class="barBlue"><div class="fn-label"></div></div>')
			.addClass(cls)
                        .css({
                            width: ((cellWidth * days) - barMarg) + 2
                        }) 			
                ...
                bar.click(function (e) {
                    e.stopPropagation();
                    settings.onItemClick($(this).data("dataObj") , label)//($(this).data("dataObj"));
					//alert("test");
                });
                return bar;
            },
			...
			// Change zoom level
            selectedZoom: function (element, val, scaleValue) {
                core.waitToggle(element, true, function () {

                    var zoomIn = (val < 0);
					//alert(element.scaleStep);
                    var scaleSt;// = element.scaleStep + val * 3;
                    //scaleSt = scaleSt <= 1 ? 1 : scaleSt === 4 ? 3 : scaleSt;
                    var scale = settings.scale;
                    var headerRows;// = element.headerRows;
                    if (scaleValue === "hours") {
                        ...
                        scaleSt = 1;
						zoomIn = true;
                    } else if (scaleValue === "days") {                        
						scale = "days";
                        headerRows = 4;
                        scaleSt = 13;
                    } else if (scaleValue === "weeks") {
                        scale = "weeks";
                        headerRows = 3;
                        scaleSt = 13;
                    } else if (scaleValue === "months") {
                        scale = "months";
                        headerRows = 2;
                        scaleSt = 14;
						zoomIn = false;
